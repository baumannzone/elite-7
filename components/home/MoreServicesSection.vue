        ...
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
          ...
          >
            ...
            <div class="flex">
              ...
              <div class="ml-3">
                <dt class="text-lg leading-6 font-medium text-gray-900">
                  Contratos de arrendamiento, actualizaciones, anexos y juicios
                </dt>
                <dd class="mt-2 text-base text-gray-500">
            ...
            <div class="flex">
              ...
              <div class="ml-3">
                <dt class="text-lg leading-6 font-medium text-gray-900">
                  Testamentos, herencias, donaciones, juicios
                </dt>
                <dd class="mt-2 text-base text-gray-500">
            ...
            <div class="flex">
              ...
              <div class="ml-3">
                <dt class="text-lg leading-6 font-medium text-gray-900">
                  Contratos de compra-venta, permutas y otros
                </dt>
                <dd class="mt-2 text-base text-gray-500">
