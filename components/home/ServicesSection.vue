      ...
      <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center">
            ...
            >
              Consultoría y asesoramiento en Madrid
            </p>
            <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Prestamos servicios de consultoría y asesoramiento fiscal,
              contable, jurídico y laboral. Para ti o para tu empresa, en
              Madrid.
            </p>
          </div>
            ...
            >
              ...
              <div class="flex">
                ...
                <div class="ml-4">
                  ...
                  <dd class="mt-2 text-base text-gray-500">
                    Elaboración de nóminas, seguros sociales, impuestos. Altas,
                    bajas, modificaciones en seguridad social.
                  </dd>
                </div>
              </div>
            </dl>
