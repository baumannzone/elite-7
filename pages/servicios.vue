<template>
  <div>
    ...
    <div class="bg-red-50">
      <div
        class="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:py-24 lg:px-8 lg:flex lg:items-center lg:justify-between"
      >
        <h2
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
              ...
              <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                ...
                contable, jurídico y laboral a particulares y empresas.
              </p>
            </div>
                ...
                <div class="flex">
                  ...
                  <div class="ml-4">
                    ...
                    <dd class="mt-2 text-base text-gray-500">
                      Asesoramiento en todo tipo de materia tributaria a
